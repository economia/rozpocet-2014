...
$centerText = $ "<span id='content'>Návrh výdajů státního rozpočtu pro rok 2014<small>Najeďte myší nad výseč a&nbsp;prohlédněte si jednotlivé kapitoly.<br />Klikněte pro přiblížení.</small></span>"
